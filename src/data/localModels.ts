...
export const whisperModels: TranscriptionModel[] = [
  // Whisper Tiny
  {
    ...
    icon: '🎯',
    type: 'local',
    category: ['all', 'local', 'fast', 'offline'],
    accuracy: 2,
    speed: 5,
    languages: ['多语言'],
    realtime: false,
  ...
  // Whisper Small
  {
    ...
    icon: '🎤',
    type: 'local',
    category: ['all', 'local', 'accurate', 'offline'],
    accuracy: 4,
    speed: 3,
    languages: ['多语言'],
    realtime: false,
  ...
  // Whisper Medium
  {
    ...
    icon: '💎',
    type: 'local',
    category: ['all', 'local', 'accurate', 'offline', 'punctuation'],
    accuracy: 4,
    speed: 2,
    languages: ['多语言'],
    realtime: false,
  ...
  // Whisper Large
  {
    ...
    icon: '👑',
    type: 'local',
    category: ['all', 'local', 'accurate', 'offline', 'punctuation', 'subtitle'],
    accuracy: 5,
    speed: 1,
    languages: ['多语言 (99种语言)'],
    realtime: false,
  ...
  // Whisper Large v3 Turbo
  {
    ...
    icon: '🚀',
    type: 'local',
    category: ['all', 'local', 'accurate', 'offline', 'fast', 'punctuation'],
    accuracy: 4,
    speed: 3,
    languages: ['多语言 (99种语言)'],
    realtime: false,
  ...
  // 英文优化模型
  {
    ...
    icon: '🇬🇧',
    type: 'local',
    category: ['all', 'local', 'accurate', 'offline', 'fast'],
    accuracy: 5,
    speed: 4,
    languages: ['仅英语'],
    realtime: false,
